...
MAX_FEATURES = 11353  # set your fixed vocab/features size here
...
def save_tensors(tf_datasets: Dict[str, tf.data.Dataset], name: str) -> Path:
        ...
        for split_name, dataset in tf_datasets.items():
            ...
            for sample in dataset:
                for key, value in sample.items():  # type: ignore
                    ...
                    if arr.ndim > 0:
                        arr = _pad_or_truncate_last_dim(arr, MAX_FEATURES)
