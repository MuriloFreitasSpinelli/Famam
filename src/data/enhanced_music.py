...
from data.giga_midi import is_giga_metadata_complete
...
def sample_to_enhanced_music(sample: Dict[str, Any]) -> EnhancedMusic:
    ...
    # Add has_drums convenience field
    drum_category = sample['instrument_category__drums-only__0__all-instruments-with-drums__1_no-drums__2']
